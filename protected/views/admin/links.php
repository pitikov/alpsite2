...
<p class='note'>Изображение может быть как выбранно с сетевых рессурсов, так и загруженно на сервер. В случае заполнения обои полей будет использованно изображение загруженное пользователем.</p>
